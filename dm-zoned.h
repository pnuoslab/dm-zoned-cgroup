...
#define DMZ_MIN_WEIGHT		0
#define DMZ_MAX_WEIGHT		1000
#define DMZ_WEIGHT_LEGACY_DFL	0
...
struct dmz_qnode {
	...
	unsigned int  		id;
	struct dmz_cgroup	*dcg;
	int count;
};


struct dmz_cgroup {
        struct cgroup_subsys_state 	*cg;
        struct dmz_qnode		dmz_qnode;
...
//added void dmz_check_bio(struct dmz_metadata *zmd, int css_id);
